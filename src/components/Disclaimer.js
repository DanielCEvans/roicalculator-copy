...
const Disclaimer = () => {
  return (
    <>
      <TextSection
        text={
          <>
            ...
            aggregated Employment Hero platform data to analyse Australian Small
            and Medium Businesses’ market trends (SMBs). It is provided in good
            faith to assist employers and their employees. The data has been
            prepared by{" "}
            <a href="https://employmenthero.com/" target="_blank">
              Employment Hero Pty Ltd © 2023
            </a>{" "}
            (ABN 11 160 047 709) and its related bodies corporate (Employment
            Hero) and is current as at November 2022.
          </>
        }
      />
      <TextSection
        text="Although the data is believed to be accurate and representative of SMBs
        in Employment Hero’s own customer base, it has not been independently
        verified."
      />
      <TextSection
        text="Employment Hero does not warrant that this data is representative of
        SMBs across Australia, that it is complete, accurate, up to date or fit
        for the purpose for which it is required."
      />
      <TextSection
        text="Employment Hero strongly advises that organisations conduct their own
      ...
      />
      <TextSection
        text="Employment Hero does not accept responsibility for any inaccuracy in
